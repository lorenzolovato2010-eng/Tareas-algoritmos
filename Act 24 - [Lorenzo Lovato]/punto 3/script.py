...
def cargar():
    ...
    for i in range(3):
        ...
        while continuar.lower() == "si":
            ...
            dispositivo.append((nombre_disp, consumo))

            continuar = input(
                "¿Desea ingresar otro dispositivo en esta habitación? : "
            )

        hogar[ambiente] = dispositivo
...
def consumo_por_habitacion(hogar):
    for ambiente, dispositivos in hogar.items():
        ...
        for disp in dispositivos:
            totalwatts = totalwatts + disp[1]

        print("Habitación:", ambiente, "Consumo Total:", totalwatts, "Watts")
