...
def procesar_registro(registro, balance, sospechosas):
...
def procesar_transacciones(cadena):
    ...
    for registro in registros:
        balance = procesar_registro(registro, balance, sospechosas)

    return balance, sospechosas


def mostrar_resultado(balance, sospechosas):
...
mostrar_resultado(balance, sospechosas)