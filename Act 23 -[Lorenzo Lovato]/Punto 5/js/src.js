...
function buscarMayorPrioridad(cola){
...
function eliminarPaciente(cola, posicion){

    let paciente = cola.splice(posicion, 1);
...
function atenderSiguiente(cola){
    ...
    let posicion = buscarMayorPrioridad(cola);

    let paciente = eliminarPaciente(cola, posicion);

    console.log("Paciente atendido:", paciente[0]);
    console.log("Nivel de urgencia:", paciente[1]);
}
